...
describe('getNextStreamingTentativeText', () => {
  it('reveals one additional word toward target text', () => {
    expect(getNextStreamingTentativeText('', 'Hello there student')).toBe('Hello')
    expect(getNextStreamingTentativeText('Hello', 'Hello there student')).toBe('Hello there')
    expect(getNextStreamingTentativeText('Hello there', 'Hello there student')).toBe('Hello there student')
  })

  it('restarts from first word when target text is corrected', () => {
    expect(getNextStreamingTentativeText('Hello there', 'Hi everyone')).toBe('Hi')
  })
})
